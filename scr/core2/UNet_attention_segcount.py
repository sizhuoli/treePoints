...
def UNet(input_shape, layer_count=64, regularizers = regularizers.l2(0.0001), gaussian_noise=0.1, weight_file = None, inputBN = 0):
        ...
        d = layers.Conv2D(1, (1, 1), activation='sigmoid', kernel_regularizer= regularizers, name = 'output_seg')(n9)

        # density map
        d2 = layers.Conv2D(1, (1, 1), activation='linear', kernel_regularizer= regularizers, name = 'output_dens')(n9)
